...
class LocalUserCursorDatabase(context: Context) : LocalUserDao, SQLiteOpenHelper(
    context,
    DATABASE_NAME,
    null,
    DATABASE_VERSION
    ...
    companion object {
        ...
        fun getDatabase(context: Context): LocalUserCursorDatabase {
            // if the INSTANCE is not null, then return it,
            // if it is, then create the database
            return INSTANCE ?: synchronized(this) {
                val instance = LocalUserCursorDatabase(context.applicationContext)
                INSTANCE = instance
                // return instance
                instance
            }
